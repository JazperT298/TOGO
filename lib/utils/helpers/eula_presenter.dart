// // ignore_for_file: avoid_print, prefer_is_empty, unnecessary_null_comparison, unused_local_variable, unrelated_type_equality_checks

// import 'dart:convert';

// import 'package:flutter/material.dart';
// import 'package:ibank/common/app_session_manager.dart';
// import 'package:ibank/data/helpers/request_otp_model.dart';
// import 'package:ibank/data/helpers/sql_helper.dart';
// import 'package:ibank/data/static/core/app_string_validation.dart';
// import 'package:ibank/data/static/core/app_strings.dart';
// import 'package:ibank/data/static/core/soap_config.dart';
// import 'package:ibank/data/static/core/sysprop.dart';
// import 'package:ibank/data/static/sms/sms_listener.dart';
// import 'package:ibank/data/static/sms/sms_option_enum.dart';
// import 'package:ibank/data/static/sms/sms_sender.dart';
// import 'package:ibank/handlers/message_handler.dart';
...
//       if (MessageHandlers.classObj != null && MessageHandlers.classObj.length != 0) {
//         Message msg1 = Message.withSource(context, response, "sms");
//         if (MessageHandlers.parseMessage(msg1) == false) {
