...
class MerchantPaymentAmountsBottomSheet {
  static void showBottomSheetMerchantInputAmount() {
  ...
  static void showBottomSheetMerchantEcobankInputAmount() {
    var controller = Get.find<PaymentController>();
    Get.bottomSheet(backgroundColor: Colors.transparent, KeyboardVisibilityBuilder(builder: (context, isKeyboardVisible) {
      return BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 4, sigmaY: 4),
