...
class TvChannelsInputsBottomSheet {
  static void showBottomSheetTvChannelsInputNumber() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Obx(
                        () => Text(
                          'Subscription ${controller.selectedOption.value}'.toUpperCase(),
                        ...
                        children: [
                          Expanded(
                            child: FluTextField(
                              ...
                              onFieldSubmitted: (p0) {
                                ...
                                // }
                                Get.back();
                                showBottomSheetTvChannelsNewCard();
                              },
                            ),
                          ),
                          Padding(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                                ...
                                child: const FluIcon(FluIcons.bookmark2, size: 20)),
                          ),
                        ],
                      ),
                    ),
  ...
  static void showBottomSheetTvChannelsNewCard() {
    var controller = Get.find<PaymentController>();
    Get.bottomSheet(backgroundColor: Colors.transparent, KeyboardVisibilityBuilder(builder: (context, isKeyboardVisible) {
      return BackdropFilter(
        filter: ImageFilter.blur(sigmaX: 4, sigmaY: 4),
