                                ...
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      ...
                                      style: GoogleFonts.montserrat(fontWeight: FontWeight.w500, color: const Color(0xFF124DE5), fontSize: 19.sp),
                                    ),
                                    // TextSpan(
                                    //   text: 'account using ',
                                    //   style: TextStyle(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                "Package",
                                style: GoogleFonts.montserrat(fontWeight: FontWeight.w400, color: const Color(0xFF27303F), fontSize: 13.sp),
                              ),
                            ),
                            Expanded(
                              child: Text(
