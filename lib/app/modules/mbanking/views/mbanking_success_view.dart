...
import 'package:ibank/app/modules/mbanking/views/dialog/mbanking_dialog.dart';
import 'package:ibank/utils/configs.dart';
import 'package:ibank/utils/constants/app_images.dart';
import 'package:sizer/sizer.dart';

class MBangkingSuccessView extends StatelessWidget {
  const MBangkingSuccessView({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    MBankingMenuDialog.showRecapOperationDialog(context);
                  },
                  child: Container(
