...
class MBankingOraBankSubMenuBottomSheet {
  static void showMBankingOraBankSubMenuBottomSheet() {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 5.w, right: 5.w),
                        child: Text(
                          "Operate your transactions between Moov Money Flooz and your Orabank account with complete peace of mind",
                          style: GoogleFonts.montserrat(
