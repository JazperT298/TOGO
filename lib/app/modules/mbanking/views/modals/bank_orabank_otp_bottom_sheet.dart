...
class MBankingOraBankOTpBottomSheet {
  static void showMBankingOraBankOtpBottomSheet() {
                            ...
                            controller.selectedSubMenu.value ==
                                ...
                                : TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            'Orabank ', // 'Vous allez envoyer de l’argent à ',
                                        style: GoogleFonts.montserrat(
                                            fontWeight: FontWeight.w600,
                                            color: const Color(0xFFFB6404),
                                            fontSize:
                            ...
                            if (controller.codeTextField.text.isNotEmpty) {
                              ...
                              if (verified) {
                                if (controller.selectedSubMenu.value ==
                                  ...
                                  // TODO: FINAL HIT ORABANK
                                  // controller.sendEcoBankFinalTransaction(
